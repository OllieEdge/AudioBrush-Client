package com.edgington.util.localisation{	
	...
	/**
	 * Generic string manipulation tools.
	 * 
	...
	public class StringTools {
		 ...
		 * @returns A boolean value indicating whether the strings' values are equal in a case sensitive compare.
		 */
		...
		public static function trim(input : String) : String {
			return StringTools.ltrim( StringTools.rtrim( input ) );
		}
		...
		public static function remove(input : String, remove : String) : String {
			return StringTools.replace( input, remove, "" );
		}
