package com.edgington.view.game.draw.pinceles
{
    ...
    public class pincelPrincipal2 extends Object implements BrushManager
    {
        ...
        public function pincelPrincipal2() : void
        {
            var _loc_1:Array = null;
            var _loc_2:int = 0;
            pressure = pincelPrincipal2.minimumPressure;
        ...
        public function get actualBrush() : Brush
        {
            ...
            _loc_9 = Canvas.mouseX_2;
            _loc_10 = Canvas.mouseY_2;
            ...
            _loc_3 = pincelPrincipal2.basicThickness + trackVolume * pincelPrincipal2.variableThickness;
            _loc_4 = pincelPrincipal2.basicThickness + trackVolume * (pincelPrincipal2.variableThickness + pincelPrincipal2.harmonicThickness * Sketcher.applyHarmonics(2));
            _loc_5 = pincelPrincipal2.basicThickness + trackVolume * (pincelPrincipal2.variableThickness + pincelPrincipal2.harmonicThickness * Sketcher.applyHarmonics(2, 250));
			
            _loc_7 = pincelPrincipal2.basicIrregularity + trackVolume * pincelPrincipal2.variableIrregularity;
