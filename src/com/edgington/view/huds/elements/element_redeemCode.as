package com.edgington.view.huds.elements
{
	...
	public class element_redeemCode extends Sprite
	{
		
		private var search:ui_iphoneSearchLeaderboards;
		
		private var noText:String;
		
		private var searchSignal:Signal;
		
		public function element_redeemCode(searchSignal:Signal)
		{
			super();
			
			this.searchSignal  = searchSignal;
			
			search = new ui_iphoneSearchLeaderboards();
			noText = gettext("redeem_code_template");
			...
			search.scaleX = search.scaleY = DynamicConstants.MESSAGE_SCALE;
