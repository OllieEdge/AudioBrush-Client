package com.edgington.view.huds.elements
{
	...
	public class element_mainButton extends Sprite implements IAudioBrushButton
	{
		private const PADDING:int = 20;
		
		private var button:ui_mainButton;
		...
		private var premiumCost:int = 0;
		
		public function element_mainButton(_str:String, _buttonOption:String, _premiumCost:int = 0)
		{
			super();
			
			this.premiumCost = _premiumCost;
			this.buttonOption = _buttonOption;
			
			button = new ui_mainButton();
			if(premiumCost == 0){
				button.txt_premium.visible = false;
			}
			else{
			...
			this.scaleX = this.scaleY = DynamicConstants.BUTTON_SCALE;
