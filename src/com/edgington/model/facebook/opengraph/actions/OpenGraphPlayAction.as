package com.edgington.model.facebook.opengraph.actions
{
	...
	public class OpenGraphPlayAction implements IOpenGraphAction
	{
		
		private var _actionType:String = ActionTypes.OPEN_GRAPH_PLAY_ACTION;
		private var _actionObject:IOpenGraphObject;
		
		private var _explicitlyShared:Boolean;
		
		public function OpenGraphPlayAction(openGraphObject:IOpenGraphObject, explicitlyShared:Boolean = false)
		{
