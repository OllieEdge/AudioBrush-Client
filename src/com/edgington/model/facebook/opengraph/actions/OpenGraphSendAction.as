package com.edgington.model.facebook.opengraph.actions
{
	...
	public class OpenGraphSendAction implements IOpenGraphAction
	{
		
		private var _actionType:String = ActionTypes.OPEN_GRAPH_SEND_ACTION;
		private var _actionObject:IOpenGraphObject;
		
		private var _explicitlyShared:Boolean;
		
		public function OpenGraphSendAction(openGraphObject:IOpenGraphObject, explicitlyShared:Boolean = false)
		{
