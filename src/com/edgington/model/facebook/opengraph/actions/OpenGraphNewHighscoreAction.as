package com.edgington.model.facebook.opengraph.actions
{
	...
	public class OpenGraphNewHighscoreAction implements IOpenGraphAction
	{
		
		private var _actionType:String = ActionTypes.OPEN_GRAPH_GET_ACTION;
		private var _actionObject:IOpenGraphObject;
		
		private var _explicitlyShared:Boolean;
		
		public function OpenGraphNewHighscoreAction(openGraphObject:IOpenGraphObject, explicitlyShared:Boolean = false)
		{
