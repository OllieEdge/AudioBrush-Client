package com.edgington.model.facebook.opengraph.actions
{
	...
	public class OpenGraphAchieveAction implements IOpenGraphAction
	{
		
		private var _actionType:String = ActionTypes.OPEN_GRAPH_ACHIEVE_ACTION;
		private var _actionObject:IOpenGraphObject;
		
		private var _explicitlyShared:Boolean;
		
		public function OpenGraphAchieveAction(openGraphObject:IOpenGraphObject, explicitlyShared:Boolean = false)
		{
